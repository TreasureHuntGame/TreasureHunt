...
<head>
    ...
    <title>TreasureHunt{Security} -- Página Não Encontrada -- Erro 404</title>
...
<body class="text-light bg-dark">
    ...
    <main>
        <div class="jumbotron bg-dark">
            ...
            TreasureHunt<span id="espaco"> </span><span class="destaque">{</span>404<span class="destaque">}</span>
            </h1>
            <p>Você tentou acessar uma página inexistente. Volte para o início ou aguarde 10 segundos para o redirecionamento automático <span class="smile destaque">:)</span></p>
        </div>
